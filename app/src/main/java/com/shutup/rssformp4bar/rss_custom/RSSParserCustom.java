 ...
 */
public class RSSParserCustom implements RSSParserSPI {
    private final RSSConfig config;
    private final RSSHandler handler;

    public RSSParserCustom(RSSHandler handler) {
        this.config = new RSSConfig();
        this.handler = handler;
    }

    public RSSParserCustom(RSSConfig config, RSSHandler handler) {
        this.config = config;
        this.handler = handler;
    }
