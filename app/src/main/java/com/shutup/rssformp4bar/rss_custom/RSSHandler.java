 ...
 * @author Mr Horn
 */
public class RSSHandler extends org.xml.sax.helpers.DefaultHandler  implements ParserRss{
    ...
    public Setter SET_TITLE() {
         ...
         * {@link #item} is set.
         */
        final Setter SET_TITLE = new ContentSetter() {
            @Override
    ...
    public Setter SET_DESCRIPTION() {
         ...
         * {@link #item} is set.
         */
        final Setter SET_DESCRIPTION = new ContentSetter() {
            @Override
    ...
    @Override
    public Setter SET_CONTENT() {
        /**
         * Setter for an RSS &lt;content:encoded&gt; element inside an &lt;item&gt;
         * element.
         */
        final Setter SET_CONTENT = new ContentSetter() {
            @Override
    ...
    public Setter SET_LINK() {
         ...
         * {@link #item} is set.
         */
        final Setter SET_LINK = new ContentSetter() {
            @Override
    ...
    public Setter SET_PUBDATE() {
         ...
         * {@link #item} is set.
         */
        final Setter SET_PUBDATE = new ContentSetter() {
            @Override
    ...
    @Override
    public Setter SET_LAST_BUILD_DATE() {
        /**
         * Setter for RSS &lt;lastBuildDate&gt; elements inside a &lt;channel&gt;.
         */
        final Setter SET_LAST_BUILD_DATE = new ContentSetter() {
            @Override
            public void set(String pubDate) {
                final java.util.Date date = Dates.parseRfc822(pubDate);
                if (item == null) {
        ...
        return SET_LAST_BUILD_DATE;
    }

    @Override
    public Setter SET_TTL() {
        /**
         * Setter for RSS &lt;ttl&gt; elements inside a &lt;channel&gt;.
         */
        final Setter SET_TTL = new ContentSetter() {
            @Override
    ...
    public Setter ADD_CATEGORY() {
         ...
         * {@link #item} is set.
         */
        final Setter ADD_CATEGORY = new ContentSetter() {
    ...
    @Override
    public Setter ADD_MEDIA_THUMBNAIL() {
        /**
         ...
         */
        final Setter ADD_MEDIA_THUMBNAIL = new AttributeSetter() {
        ...
        return ADD_MEDIA_THUMBNAIL;
    }

    @Override
    public Setter SET_ENCLOSURE() {
        /**
         * Setter for RSS &lt;enclosure&gt; elements inside an &lt;item&gt; element.
         */
        final Setter SET_ENCLOSURE = new AttributeSetter() {
